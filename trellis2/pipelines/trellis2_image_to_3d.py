...
class Trellis2ImageTo3DPipeline(Pipeline):
    ...
    def from_pretrained(cls, path: str, config_file: str = "pipeline.json", keep_models_loaded = True, use_fp8 = False) -> "Trellis2ImageTo3DPipeline":
        ...
        pipeline._pretrained_args['models']['sparse_structure_decoder'] = "ckpts/ss_dec_conv3d_16l8_fp16"

        for key in [
            'sparse_structure_flow_model', 'sparse_structure_decoder',
            'shape_slat_flow_model_512', 'tex_slat_flow_model_512', 
            'tex_slat_decoder', 'shape_slat_decoder', 
            'shape_slat_flow_model_1024', 'tex_slat_flow_model_1024', 
            'shape_slat_encoder'
        ]:
            if key not in pipeline.models:
                pipeline.models[key] = None
